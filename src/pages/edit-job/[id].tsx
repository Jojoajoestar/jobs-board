 ...
 *
 * This component renders a form to edit an existing job listing.
 * It fetches job details using the job ID from the URL and allows updating the job information.
 *
 * Example:
 * <EditJobPage />
 */
...
const EditJobPage: React.FC = () => {
  ...
  // Render loading indicator if job details are still being fetched
  if (!job) {
